...
.table-wrapper { overflow-x: auto; border: 1px solid var(--admin-border); border-radius: 7px; }table { width: 100%; min-width: 720px; border-collapse: collapse; }thead { background: #f4eee9; }th { height: 48px; font-size: 13px; }td { height: 54px; padding: 8px 14px; border-bottom: 1px solid var(--admin-border); text-align: center; font-size: 13px; }.notice-row { cursor: pointer; }.notice-row:hover { background: #fffaf6; }.notice-row:focus-visible { outline: 3px solid rgb(243 136 59 / 22%); outline-offset: -3px; }.notice-title { text-align: left; }.notice-title:hover { color: var(--admin-orange); }.management-buttons { display: flex; justify-content: center; gap: 6px; }.management-buttons button { height: 27px; padding: 0 10px; border-radius: 5px; background: #fff; font-size: 11px; cursor: pointer; }.edit-button { border: 1px solid var(--admin-border); color: var(--admin-text); }.delete-button { border: 1px solid #ef857d; color: #e45f58; }
